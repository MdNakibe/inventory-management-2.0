...
export default{
    ...
    async created() {
        ...
        if (this.$route.params.id){
            await this.$store.dispatch('supplier/getSupplierPaymentRecord', {payment_id: this.$route.params.id});
    ...
    methods: {
        ...
        handlePaymentProcess() {
            this.serverdata = this.$store.getters['supplier/supplierPaymentRecord'];
            if (this.serverdata) {
